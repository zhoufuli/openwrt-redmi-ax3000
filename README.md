...
| Device        | Boot | Switch | CPU Ethernet      | NAT      | 2.4G WiFi   | 5G WiFi |
| :-:           | :-:  | :-:    | :-:               | :-:      | :-:         | :-:     |
| Redmi AX3000  | ❓ No test |
| Xiaomi CR8806 | ✔️  | ✔️     | ⚠️ Slow `uplink` | ⚠️ Slow¹ | ⚠️ Unstable | ✔️      |
| Xiaomi CR8808 | ✔️  | ✔️     | ⚠️ Slow `uplink` | ⚠️ Slow¹ | ⚠️ Unstable | ✔️      |
| Xiaomi CR8809 | ❓ No test |
> NOTE¹: Due to the lack of NSS Offloading support, hardware NAT can't be enabled now. What we can use is the software offloading which require lots of CPU usage.
